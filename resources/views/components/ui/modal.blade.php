...
@php
    $modalId = $modalId ?? 'modal-' . md5(uniqid());
@endphp
...
<div x-data="{
    ...
    @open-regular-modal.window="open = true"
    @close-regular-modal.window="open = false"
    class="modal fixed inset-0 z-99999 flex items-center justify-center overflow-y-auto p-5" id="{{ $modalId }}"
