<header
    class="sticky top-0 flex w-full backdrop-blur-md bg-white/80 border-slate-200 z-50 dark:border-slate-800 dark:bg-slate-900/80 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <button
                class="hidden xl:flex items-center justify-center w-10 h-10 text-slate-500 border border-slate-200 rounded-lg dark:border-slate-800 dark:text-slate-400 lg:h-11 lg:w-11 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50"
            ...
            <button
                class="flex xl:hidden items-center justify-center w-10 h-10 text-slate-500 rounded-lg dark:text-slate-400 lg:h-11 lg:w-11 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50"
            ...
            <button @click="toggleApplicationMenu()"
                class="flex items-center justify-center w-10 h-10 text-slate-700 rounded-lg z-50 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 xl:hidden">
                <!-- Dots Icon -->
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                <!-- Theme Toggle Button -->
                <button
                    class="relative flex items-center justify-center text-slate-500 transition-all bg-white border border-slate-200 rounded-full hover:text-slate-900 h-11 w-11 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white"
