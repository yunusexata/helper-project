...
@endphp
  <div class="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1 bg-gray-50 dark:bg-gray-900">
      ...
      <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          ...
          <img src="/images/error/500.svg" alt="500" class="dark:hidden mx-auto max-h-64 mb-8" />
          <img src="/images/error/500-dark.svg" alt="500" class="hidden dark:block mx-auto max-h-64 mb-8" />

          <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white/90">Kesalahan Server Internal</h2>
